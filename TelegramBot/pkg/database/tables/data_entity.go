...
func (de DataEntity) AddData(pool *pgx.ConnPool, data model.Data) {
...
func (de DataEntity) GetData(pool *pgx.ConnPool, id int64, service string) (model.Data, error) {
	var data model.Data
...
func (de DataEntity) DelData(pool *pgx.ConnPool, id int64, service string) error {
